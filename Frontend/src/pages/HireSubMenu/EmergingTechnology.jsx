...
const IMG = {
  hero:      "https://images.unsplash.com/photo-1677442135703-1787eea5ce01?w=1000&q=80",
  ...
  ml:        "https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=800&q=80",
  data:      "https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=800&q=80",
  salesforce:"https://images.unsplash.com/photo-1552664730-d307ca884978?w=800&q=80",
  iot:       "https://images.unsplash.com/photo-1558494949-ef010cbdcc31?w=800&q=80",
  team:      "https://images.unsplash.com/photo-1522202176988-66273c2fd55f?w=900&q=80",
  lab:       "https://images.unsplash.com/photo-1518770660439-4636190af475?w=900&q=80",
};
...
function EmerginOverview() {
  ...
  return (
    <>
        ...
        <Eyebrow>Emerging Technologies · HTD</Eyebrow>
                <h1 data-animate="fade-up" data-animate-delay="0.1" className="font-headline-xl text-3xl sm:text-5xl font-black mb-4 tracking-tight leading-none uppercase">
                       Train for technologies<br />
              <span className="text-blue-600">that define what's next.</span>
                </h1>
                <p data-animate="fade-up" data-animate-delay="0.2" className="text-sm sm:text-base text-slate-300 font-light mb-6 leading-relaxed">
                 Cloud, AI, ML, Data Science, Salesforce, IoT — we build the professionals enterprises need but can't find. Trained from the ground up. Deployed with confidence.
                </p>
...
"
>
Enterprise capabilities designed to accelerate
innovation and scalable delivery.
</p>
...
duration-300
hover:border-[#D9E5FA]
hover:shadow-[0_18px_50px_rgba(11,58,130,.08)]
"
...
transition
duration-500
bg-[radial-gradient(circle_at_top,#F5F8FF,transparent_60%)]
"
/>
...
════════════════════════════════════════════════════════════════════ */
const phases = [
  { verb:"Explore",  icon:Globe2,    color:"#1446b4", bg:"#EFF6FF",
    title:"Domain Discovery",  desc:"Guided orientation across all six technology tracks to find your strongest path." },
  { verb:"Practice", icon:Target,    color:"#1446b4", bg:"#F5F3FF",
    title:"Lab Environments",  desc:"Cloud sandboxes, AI notebooks, and IoT simulators — real tooling from week one." },
  { verb:"Apply",    icon:Layers,    color:"#1446b4", bg:"#F0F9FF",
    title:"Project Sprints",   desc:"Cross-domain capstone projects that mirror actual enterprise delivery scenarios." },
  { verb:"Deploy",   icon:Rocket,    color:"#1446b4", bg:"#ECFDF5",
    title:"Enterprise Placement", desc:"Placed into client teams with 30 days of post-deployment mentor support." },
];
...
════════════════════════════════════════════════════════════════════ */
const outcomes = [
  { value:"6",    suffix:"+",  label:"Technology Tracks",     icon:Layers,     color:"white", bg:"black" },
  { value:"94",   suffix:"%",  label:"Placement Success",     icon:TrendingUp, color:"white", bg:"black" },
  { value:"2400", suffix:"+",  label:"Professionals Deployed",icon:Globe2,     color:"white", bg:"black" },
  { value:"8",    suffix:"wk", label:"Avg. Training Duration",icon:Zap,        color:"white", bg:"black" },
];
    ...
    <section ref={ref} className="py-20 bg-white overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        <div className="grid lg:grid-cols-2 gap-14 items-center">
          ...
          {/* Left */}
          <Reveal>
            <Eyebrow>Why Emerging Technologies</Eyebrow>
            <h2 className="text-3xl md:text-4xl font-bold text-slate-900 leading-tight mb-5">
              Skills for the roles<br />
              <span className="text-blue-600">enterprises can't fill.</span>
            </h2>
            <p className="text-slate-500 text-[15px] leading-relaxed mb-8 max-w-sm">
              Emerging tech talent is the hardest to hire. We build it from scratch — precisely calibrated to your stack and your team.
            </p>
      ...
      <div className="relative z-10 max-w-2xl mx-auto text-center px-6">
        <Reveal>
          ...
          <h2 className="text-4xl md:text-5xl font-black text-slate-900 leading-[1.06] mb-5">
            Build skills for<br />
            <span className="text-blue-600">what comes next.</span>
          </h2>
          <p className="text-slate-400 text-[15px] max-w-sm mx-auto mb-10 leading-relaxed">
            Your team needs Cloud, AI, ML, and IoT expertise. We build it — trained precisely, deployed confidently.
          </p>
...
// -----funky style card use in diffrent website ------------------------
